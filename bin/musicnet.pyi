...
class AudioSubset():
  ...
  def stacked_data(self) -> torch.Tensor:
    """
...
class OptimizerConfig():
  ...
  def __init__(
    ...
    """
    Construct a new OptimizerConfig with optional overrides.
...
class Trainer():
  ...
  def attach(self, scheduler: ReduceLROnPlateau) -> None:
    """
  ...
  def train(self, subset: AudioSubset, batch_size: int, num_workers: int) -> tuple[float, float]:
    """
  ...
  def eval(self, subset: AudioSubset, batch_size: int, num_workers: int) -> tuple[float, float]:
    """
