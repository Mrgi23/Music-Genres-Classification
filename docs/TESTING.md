...
#### 1. Linux/WSL
```sh
sudo apt update && sudo apt install -y build-essential cmake curl g++ gcc git lcov libaubio-dev libcurl4-openssl-dev libomp-dev libzip-dev ninja-build python3.10 python3.10-dev python3.10-venv
