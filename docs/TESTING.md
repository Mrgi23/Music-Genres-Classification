...
#### 1. Linux/WSL
```sh
sudo apt update && sudo apt install -y build-essential cmake curl gcc-12 g++-12 git lcov libaubio-dev libcurl4-openssl-dev libomp-dev libzip-dev ninja-build python3.12 python3.12-dev python3.12-venv
